...
public class SQLite3PragmaGenerator {
    ...
    private enum Pragma {
        ...
        CELL_SIZE_CHECK, CHECKPOINT_FULLSYNC, DEFAULT_CACHE_SIZE, DEFER_FOREIGN_KEY,

        FOREIGN_KEYS, IGNORE_CHECK_CONSTRAINTS, INCREMENTAL_VACUUM, INTEGRITY_CHECK, JOURNAL_MODE, JOURNAL_SIZE_LIMIT,

        OPTIMIZE, LEGACY_FORMAT, LOCKING_MODE, MMAP_SIZE, RECURSIVE_TRIGGERS, REVERSE_UNORDERED_SELECTS, SECURE_DELETE,
        SHRINK_MEMORY, SOFT_HEAP_LIMIT, STATS, SHORT_COLUMN_NAMES,

        THREADS, WAL_AUTOCHECKPOINT, WAL_CHECKPOINT;
