...
public enum YSQLFunctionWithUnknownResult {
    ...
    CURRENT_DATABASE("current_database", YSQLDataType.TEXT),

    CURRENT_SCHEMA("current_schema", YSQLDataType.TEXT),
    ...
    CEILING("ceiling", YSQLDataType.REAL), DEGREES("degrees", YSQLDataType.REAL), EXP("exp", YSQLDataType.REAL),
    LN("ln", YSQLDataType.REAL), LOG("log", YSQLDataType.REAL), LOG2("log", YSQLDataType.REAL, YSQLDataType.REAL),
    PI("pi", YSQLDataType.REAL), POWER("power", YSQLDataType.REAL, YSQLDataType.REAL),
    TRUNC("trunc", YSQLDataType.REAL, YSQLDataType.INT),
    TRUNC2("trunc", YSQLDataType.REAL, YSQLDataType.INT, YSQLDataType.REAL), FLOOR("floor", YSQLDataType.REAL),

    ACOS("acos", YSQLDataType.REAL), ACOSD("acosd", YSQLDataType.REAL), ASIN("asin", YSQLDataType.REAL),
    ASIND("asind", YSQLDataType.REAL), ATAN("atan", YSQLDataType.REAL), ATAND("atand", YSQLDataType.REAL),
    ATAN2("atan2", YSQLDataType.REAL, YSQLDataType.REAL), ATAN2D("atan2d", YSQLDataType.REAL, YSQLDataType.REAL),
    COS("cos", YSQLDataType.REAL), COSD("cosd", YSQLDataType.REAL), COT("cot", YSQLDataType.REAL),
    COTD("cotd", YSQLDataType.REAL), SIN("sin", YSQLDataType.REAL), SIND("sind", YSQLDataType.REAL),
    TAN("tan", YSQLDataType.REAL), TAND("tand", YSQLDataType.REAL),

    SINH("sinh", YSQLDataType.REAL), COSH("cosh", YSQLDataType.REAL), TANH("tanh", YSQLDataType.REAL),
    ASINH("asinh", YSQLDataType.REAL), ACOSH("acosh", YSQLDataType.REAL), ATANH("atanh", YSQLDataType.REAL),
