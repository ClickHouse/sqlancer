...
public class CockroachDBUnaryPostfixOperation extends
    ...
    public enum CockroachDBUnaryPostfixOperator implements Operator {
        IS_NULL("IS NULL"), IS_NOT_NULL("IS NOT NULL"), IS_NAN("IS NAN"), IS_NOT_NAN("IS NOT NAN"), IS_TRUE("IS TRUE"),
        IS_FALSE("IS FALSE"), IS_NOT_TRUE("IS NOT TRUE"), IS_NOT_FALSE("IS NOT FALSE");
