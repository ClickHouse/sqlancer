...
public final class DuckDBExpressionGenerator extends UntypedExpressionGenerator<DuckDBExpression, DuckDBColumn>
    ...
    public enum DBFunction {
        ...
        ACOS(1), ASIN(1), ATAN(1), COS(1), SIN(1), TAN(1), COT(1), ATAN2(1),

        ABS(1), CEIL(1), CEILING(1), FLOOR(1), LOG(1), LOG10(1), LOG2(1), LN(1), PI(0), SQRT(1), POWER(1), CBRT(1),
        ROUND(2), SIGN(1), DEGREES(1), RADIANS(1), MOD(2), XOR(2),

        LENGTH(1), LOWER(1), UPPER(1), SUBSTRING(3), REVERSE(1), CONCAT(1, true), CONCAT_WS(1, true), CONTAINS(2),
        PREFIX(2), SUFFIX(2), INSTR(2), PRINTF(1, true), REGEXP_MATCHES(2), REGEXP_REPLACE(3), STRIP_ACCENTS(1),
