...
public class DataFusionBaseExpr implements Operator {
    ...
    public enum DataFusionBaseExprType {
        ...
        EQUAL, EQUAL2, NOT_EQUAL, LESS_THAN, LESS_THAN_OR_EQUAL_TO, GREATER_THAN, GREATER_THAN_OR_EQUAL_TO,

        IS_DISTINCT_FROM, IS_NOT_DISTINCT_FROM,

        AND, OR,

        BITWISE_AND, BITWISE_OR, BITWISE_XOR, BITWISE_SHIFT_RIGHT, BITWISE_SHIFT_LEFT,

        NOT, PLUS, MINUS,

        FUNC_ABS, FUNC_ACOS, FUNC_ACOSH, FUNC_ASIN, FUNC_ASINH, FUNC_ATAN, FUNC_ATANH, FUNC_ATAN2, FUNC_CBRT, FUNC_CEIL,
        FUNC_COS, FUNC_COSH, FUNC_DEGREES, FUNC_EXP, FUNC_FACTORIAL, FUNC_FLOOR, FUNC_GCD, FUNC_ISNAN, FUNC_ISZERO,
        FUNC_LCM, FUNC_LN, FUNC_LOG, FUNC_LOG_WITH_BASE, FUNC_LOG10, FUNC_LOG2, FUNC_NANVL, FUNC_PI, FUNC_POW,
        FUNC_POWER, FUNC_RADIANS,

        FUNC_ROUND, FUNC_ROUND_WITH_DECIMAL, FUNC_SIGNUM, FUNC_SIN, FUNC_SINH, FUNC_SQRT, FUNC_TAN, FUNC_TANH,
        FUNC_TRUNC, FUNC_TRUNC_WITH_DECIMAL,

        FUNC_COALESCE, FUNC_NULLIF, FUNC_NVL, FUNC_NVL2, FUNC_IFNULL,
