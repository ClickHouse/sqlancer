...
/**
 * Map key access. ClickHouse renders as {@code m['key']} (the key is itself an expression that
 * the visitor renders via the standard expression path; the brackets are the access operator).
 *
