...
public enum MaterializeFunctionWithUnknownResult {
    ...
    ACOS("acos", MaterializeDataType.REAL), ACOSD("acosd", MaterializeDataType.REAL),
    ASIN("asin", MaterializeDataType.REAL), ASIND("asind", MaterializeDataType.REAL),
    ATAN("atan", MaterializeDataType.REAL), ATAND("atand", MaterializeDataType.REAL),
    ATAN2("atan2", MaterializeDataType.REAL, MaterializeDataType.REAL),
    ATAN2D("atan2d", MaterializeDataType.REAL, MaterializeDataType.REAL), COS("cos", MaterializeDataType.REAL),
    COSD("cosd", MaterializeDataType.REAL), COT("cot", MaterializeDataType.REAL),
    COTD("cotd", MaterializeDataType.REAL), SIN("sin", MaterializeDataType.REAL),
    SIND("sind", MaterializeDataType.REAL), TAN("tan", MaterializeDataType.REAL),
    TAND("tand", MaterializeDataType.REAL),

    SINH("sinh", MaterializeDataType.REAL), COSH("cosh", MaterializeDataType.REAL),
    TANH("tanh", MaterializeDataType.REAL), ASINH("asinh", MaterializeDataType.REAL),
    ACOSH("acosh", MaterializeDataType.REAL), ATANH("atanh", MaterializeDataType.REAL),
