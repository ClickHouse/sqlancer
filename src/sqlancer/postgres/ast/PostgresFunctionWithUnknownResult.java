...
public enum PostgresFunctionWithUnknownResult {
    ...
    ACOS("acos", PostgresDataType.REAL), ACOSD("acosd", PostgresDataType.REAL), ASIN("asin", PostgresDataType.REAL),
    ASIND("asind", PostgresDataType.REAL), ATAN("atan", PostgresDataType.REAL), ATAND("atand", PostgresDataType.REAL),
    ATAN2("atan2", PostgresDataType.REAL, PostgresDataType.REAL),
    ATAN2D("atan2d", PostgresDataType.REAL, PostgresDataType.REAL), COS("cos", PostgresDataType.REAL),
    COSD("cosd", PostgresDataType.REAL), COT("cot", PostgresDataType.REAL), COTD("cotd", PostgresDataType.REAL),
    SIN("sin", PostgresDataType.REAL), SIND("sind", PostgresDataType.REAL), TAN("tan", PostgresDataType.REAL),
    TAND("tand", PostgresDataType.REAL),

    SINH("sinh", PostgresDataType.REAL), COSH("cosh", PostgresDataType.REAL), TANH("tanh", PostgresDataType.REAL),
    ASINH("asinh", PostgresDataType.REAL), ACOSH("acosh", PostgresDataType.REAL), ATANH("atanh", PostgresDataType.REAL),
