...
public class PostgresAlterTableGenerator {
    ...
    protected enum Action {
        ...
        ALTER_TABLE_DROP_COLUMN, ALTER_COLUMN_TYPE,

        ALTER_COLUMN_SET_DROP_DEFAULT,

        ALTER_COLUMN_SET_DROP_NULL, ALTER_COLUMN_SET_STATISTICS, ALTER_COLUMN_SET_ATTRIBUTE_OPTION,
        ALTER_COLUMN_RESET_ATTRIBUTE_OPTION, ALTER_COLUMN_SET_STORAGE, ALTER_COLUMN_DROP_EXPRESSION,
        ADD_TABLE_CONSTRAINT, ADD_TABLE_CONSTRAINT_USING_INDEX, VALIDATE_CONSTRAINT, DISABLE_ROW_LEVEL_SECURITY,
        ENABLE_ROW_LEVEL_SECURITY, FORCE_ROW_LEVEL_SECURITY, NO_FORCE_ROW_LEVEL_SECURITY, CLUSTER_ON,
        SET_WITHOUT_CLUSTER, SET_WITH_OIDS, SET_WITHOUT_OIDS, SET_LOGGED_UNLOGGED, NOT_OF, OWNER_TO, REPLICA_IDENTITY,
