...
class TestCastToNumeric {
    ...
    void testBinary() {
        List<StringTestTriple> triples = new ArrayList<>();
        triples.add(new StringTestTriple("112B3980", SQLite3DataType.INT, 0L));
        triples.add(new StringTestTriple("0936", SQLite3DataType.INT, 6L));
        triples.add(new StringTestTriple("0C36", SQLite3DataType.INT, 6L));
        triples.add(new StringTestTriple("0a36", SQLite3DataType.INT, 6L));
        triples.add(new StringTestTriple("0b36", SQLite3DataType.INT, 6L));
        triples.add(new StringTestTriple("0c36", SQLite3DataType.INT, 6L));
        triples.add(new StringTestTriple("0d36", SQLite3DataType.INT, 6L));
        triples.add(new StringTestTriple("0e36", SQLite3DataType.INT, 0L));
        ...
        triples.add(new StringTestTriple("1C32", SQLite3DataType.INT, 0L));
        triples.add(new StringTestTriple("1D32", SQLite3DataType.INT, 0L));
        triples.add(new StringTestTriple("1e32", SQLite3DataType.INT, 0L));
        triples.add(new StringTestTriple("1f32", SQLite3DataType.INT, 0L));
        triples.add(new StringTestTriple("2032", SQLite3DataType.INT, 2L));
        triples.add(new StringTestTriple("09013454", SQLite3DataType.INT, 0L));
